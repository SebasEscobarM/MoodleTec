...
$string['backtolistofrules'] = 'Regresar a la lista de reglas';
$string['before'] = 'Antes';
...
$string['delete_confirm'] = '¿Está seguro de querer eliminar la regla {$a}?';
...
$string['disable_confirm'] = '¿Está seguro de querer deshabilitar la regla {$a}?';
...
$string['enable_confirm'] = '¿Está seguro de querer habilitar la regla {$a}?';
