...
/**
 * Strings for component 'tool_moodlebox', language 'es_mx', version '4.4'.
 *
...
$string['dhcpclientinfo'] = 'Dirección IP, nombre y dirección MAC del cliente';
...
* Detalles críticos de la operación de MoodleBox como por ejemplo espacio restante de disco en la tarjeta SD y carga, temperatura y frecuencia del procesador
* Configuraciones actuales de la red Wi-Fi proporcionadas por la MoodleBox
* Número, dirección IP ,nombre y dirección MAC de todos los dispositivos conectados a la MoodleBox
...
$string['unknowndhcpname'] = '--desconocido--';
