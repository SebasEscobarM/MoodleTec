...
$string['informationblocksbuilderdesc'] = 'Use la herramienta de abajo para configurar sus bloques de información. Una vez definidos, los bloques seguirán el diseño cuando se desactive la edición.';
...
$string['showfooterblocksdesc'] = 'Mostrar / Ocultar los cuatro bloques personalizables del pie de página.';
...
$string['versionstable'] = 'Versión estable . Podría contener errores porque no hay tiempo suficiente en el universo para encontrarlos todos. Comprobar en un servidor de prueba antes de instalarla en su servidor en producción. ¡En serio, hágalo así! No se arrepentirá y podrá personalizarlo hasta que usted esté feliz, entonces use la funcionalidad para \'Importar / exportar configuraciones\' para transferir los valores de configuración, menos los archivos.';
