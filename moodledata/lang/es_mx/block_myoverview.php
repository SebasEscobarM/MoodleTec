...
/**
 * Strings for component 'block_myoverview', language 'es_mx', version '4.4'.
 *
...
$string['aria:courseactions'] = 'Acciones para curso';
...
$string['aria:hidecourse'] = 'Quitar {$a} de la vista';
$string['aria:inprogress'] = 'Mostrar cursos en progreso';
...
$string['aria:showcourse'] = 'Rsetaurar {$a} en vista';
...
$string['hiddencourses'] = 'Quitado de la vista';
