...
/**
 * Strings for component 'badges', language 'es_mx', version '4.4'.
 *
 * @package     badges
 * @category    string
...
$string['backpackconnection'] = 'Conectar a mochila';
$string['backpackconnection_connected'] = 'Su mochila';
$string['backpackconnection_help'] = 'Almacenar y compartir sus insignias de este sitio y mostrar colecciones de insignias públicas de otros sitios web en su perfil de  usuario.';
...
Ya casi ha logrado conectarse a su mochila de insignias en \'{$a->sitename}\'.

Para terminar de conectarse  a su mochila, verifique  su dirección mediante el siguiente botón,

{$a->buttonlink}

Si el  botón no  funciona, usted puede copiar y pegar la siguiente URL en su navegador:
{$a->link}

Si  usted no intentó conectarse a su mochila de insignias, puede ignorar tranquilamente este Email.

Para cualquier ayuda extra, por favor póngase en contacto con el soporte del sitio,

{$a->admin}';
$string['backpackemailverifyemailsubject'] = '{$a}: Verificación de Email de Mochila de Insignias';
$string['backpackemailverifypending'] = 'Hemos enviado un Email de notificación a <strong>{$a}</strong>. Haga clic en el enlace para verificación en el Email para activar su conexión a mochila.';
$string['backpackemailverifysuccess'] = 'Usted está ahora conectado a su mochila.';
...
$string['badgetags'] = 'Marcas de insignia';
...
$string['externalbackpack_required'] = 'El proveedor de mochila no puede estar vacío';
...
$string['loginbackpacktitle'] = '<strong>Ingresar a su mochila</strong>';
...
$string['nomatchingawards'] = 'Aun no hay destinatarios coincidentes que hayan obtenido esta insignia.';
$string['nomatchingbadges'] = 'No hay insignias coincidentes disponibles para que los usuarios las ganen.';
...
$string['verifyemail'] = 'Verificar Email';
