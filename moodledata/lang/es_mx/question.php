...
/**
 * Strings for component 'question', language 'es_mx', version '4.4'.
 *
 * @package     question
 * @category    string
...
$string['attemptfinishedsubmitting'] = 'Intento terminado enviando: {$a}';
...
$string['cannotregradedifferentqtype'] = 'No se puede re-calificar con una pregunta de un tipo diferente.';
$string['cannotretrieveqcat'] = 'No se ha podido recuperar la categoría de preguntas';
$string['cannotunhidequestion'] = 'No se pudo descubrir la pregunta.';
...
$string['changepublishstatuscat'] = '<a href="{$a->caturl}">Category "{$a->name}"</a> en curso "{$a->coursename}" cambiará su estatus de intercambio de  {$a->changefrom} a {$a->changeto}.';
...
$string['deletequestioncheck'] = 'Esto eliminará las siguientes preguntas y todas sus versiones:<br /><br />{$a}';
$string['deletequestionscheck'] = 'Esto eliminará las siguientes preguntas y todas sus versiones:<br /><br />{$a}';
$string['deletequestiontitle'] = '¿Eliminar pregunta?';
$string['deletequestiontitle_plural'] = '¿Eliminar preguntas?';
$string['deleteselectedquestioncheck'] = 'Esto eliminará versiones seleccionadas de la siguiente pregunta:<br /><br />{$a}';
$string['deleteversiontitle'] = '¿Eliminar versión seleccionada?';
$string['deleteversiontitle_plural'] = '¿Eliminar versiones seleccionadas?';
...
$string['ignorebroken'] = 'Ignorar enlaces rotos';
...
$string['importparseerror'] = 'Ocurrió un error al revisar el archivo importado. No se importaron preguntas. Para importar las preguntas buenas rescatables inténtelo de nuevo con la configuración de NO "Detenerse en error"';
...
$string['importwrongfileencoding'] = 'El archivo que usted seleccionó no usa codificación de caracteres UFT-8. {$a} archivos  deben usar UTF-8.';
...
$string['invalidgradequestion'] = 'Las calificaciones ({$a->grades}) no coinciden con las opciones de calificación - pregunta \'{$a->question}\' saltada.';
...
$string['noconditionspecified'] = 'Especifique por favor una condición';
$string['nopermissionadd'] = 'No tiene permiso para agregar preguntas aquí.';
$string['nopermissionedit'] = 'Usted no tiene permiso para editar preguntas desde aquí.';
...
$string['noquestionbanks'] = 'No se encontró ningún plugin del banco de preguntas';
...
$string['numquestionsandhidden'] = '{$a->numquestions} (+ {$a->numhidden} ocultas + {$a->numdraft} borradores)';
...
$string['privacy:metadata:database:question_bank_entries'] = 'Los detalles acerca de una entrada específica del banco de preguntas';
...
$string['privacy:metadata:link:qbehaviour'] = 'El subsistema de Pregunta hace uso del tipo de plugin de Comportamiento de Pregunta.';
...
$string['qbanknotfound'] = 'El plugin \'{$a}\' del banco de preguntas no existe o no es reconocido.';
...
$string['questionsinuse'] = '* Denota preguntas que no pueden ser eliminadas porque están en uso. En lugar de esto, estarán ocultas en el banco de preguntas a menos que usted configure \'Mostrar preguntas antiguas\' a \'Si\'.';
...
$string['restartwiththeseoptions'] = 'Guardar opción de vista previa y comenzar de nuevo';
...
$string['shortversioninfolatest'] = 'v{$a->version} (más reciente)';
...
$string['showquestiontext_full'] = 'Si, con imágenes, medios, etc.';
$string['showquestiontext_off'] = 'No';
$string['showquestiontext_plain'] = 'Si, solamente texto';
...
$string['versioninfolatest'] = 'Versión {$a->version} (más reciente)';
