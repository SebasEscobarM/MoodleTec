...
/**
 * Strings for component 'theme_boost_magnific', language 'es_mx', version '4.4'.
 *
...
$string['social_facebook_desc'] = 'La URL del Facebook de tu organización.';
...
$string['top_scroll_desc'] = 'Cuando se habilita, el menú será fijado en la parte superior de la pantalla mientras usted desplaza la página, asegurando un acceso fácil a las opciones del menú.';
