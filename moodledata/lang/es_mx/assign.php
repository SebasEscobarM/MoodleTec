...
/**
 * Strings for component 'assign', language 'es_mx', version '4.4'.
 *
 * @package     assign
 * @category    string
...
$string['activityattachments'] = 'Anexos a actividad Tarea';
$string['activitydate:submissionsdue'] = 'Cierre:';
$string['activitydate:submissionsopen'] = 'Apertura:';
$string['activitydate:submissionsopened'] = 'Abrió:';
$string['activityeditor'] = 'Instrucciones de actividad';
$string['activityeditor_help'] = 'Las acciones que usted quisiera que el estudiante complete para esta tarea. Esto solamente es mostrado en la página de envío cuando un estudiante edita y envía su tarea.';
...
$string['attemptreopenmethod_help'] = 'Esta configuración determina si es que un estudiante puede hacer intentos adicionales a la tarea. Para cada intento, la calificación y retroalimentación son guardadas, y solamente pueden ser vistas por el profesor y el estudiante. Las opciones disponibles son:

* Nunca-Solamente es posible un intento.
* Manualmente -  Envíos adicionales pueden ser permitidos por un profesor.
* Automáticamente hasta pasar - Envíos adicionales están permitidos automáticamente, hasta que el estudiante alcance la calificación necesaria para pasar (aprobar), que está configurada en el libro de calificaciones para esta tarea.';
...
$string['beginassignment'] = 'Comenzar tarea';
...
$string['caneditsubmission'] = 'Usted puede editar su envío y enviarlo después de que haya pasado el tiempo límite, pero será calificado como atrasado.';
...
$string['completionsubmit'] = 'Hacer un envío';
...
$string['confirmstart'] = 'Usted tiene {$a} para completar esta Tarea. Cuando usted comience, el reloj descendente empezará a contar y no puede ser pausado.';
...
$string['cutoffdate_help'] = 'Si se configura, la tarea no aceptará envíos después de esta fecha si no hubiera una extensión. Si no se configura, los envíos siempre serán aceptados.';
$string['cutoffdatecolon'] = 'Fecha de corte: {$a}';
$string['cutoffdatefromdatevalidation'] = 'La fecha de corte no puede ser anterior a la fecha de \'Permitir envíos a partir de\'.';
...
$string['duedate_help'] = 'Esta es la fecha cuando se debería de entregar la tarea. Los envíos seguirán siendo permitidos aún después de esta fecha, pero cualquier envío mandado después de esta fecha será marcado como \'retrasado\'. Configure una fecha de corte para evitar envíos después de una cierta fecha.';
$string['duedateaftersubmissionvalidation'] = 'Fecha esperada debe ser después de la fecha cuando se permiten  envíos.';
$string['duedatecolon'] = 'Fecha de entrega: {$a}';
$string['duedatereached'] = 'La fecha de entrega de esta tarea ya ha pasado';
...
$string['enabletimelimit'] = 'Habilitar tareas cronometradas';
$string['enabletimelimit_help'] = 'Si se habilita, usted puede configurar un límite de tiempo en la página de configuración de la tarea.';
...
$string['extensionduedatecurrent'] = 'Fecha esperada de extensión actual';
$string['extensionduedatefrom'] = 'Desde {$a}';
$string['extensionduedatenone'] = 'Ninguna';
$string['extensionduedateto'] = 'Hasta {$a}';
$string['extensionduedatewithout'] = 'Usuarios sin una extensión: {$a}';
...
$string['gradedfollowupsubmit'] = 'Calificada - re-enviada';
...
$string['gradingdueduedatevalidation'] = 'La fecha para recordarme calificar  no puede ser antes de la fecha de entrega.';
...
$string['introattachments_help'] = 'Archivos adicionales para usar en la tarea, tales como plantillas de respuesta, pueden ser añadidos.';
...
$string['markinganonymous'] = 'Permitir liberación parcial de calificaciones mientras se califica anónimamente';
$string['markinganonymous_help'] = 'Si se habilita junto con envíos anónimos y flujograma de calificación, permite la liberación parcial de calificaciones mientras se califica anónimamente.';
...
$string['maxperpage'] = 'Máximo número de Tareas por página';
...
$string['nextuser'] = 'Usuario siguiente';
...
$string['nosubmissionyet'] = 'Aun no se ha hecho ninguna tarea';
...
$string['numberofsubmissionsneedgradinglabel'] = 'Necesita calificarse: {$a}';
...
$string['overdue'] = 'La Tarea está vencida por: {$a}';
...
$string['privacy:metadata:timestarted'] = 'Hora de iniciada';
...
$string['removesubmissionconfirm'] = '¿Está seguro de querer eliminar su envío?';
$string['removesubmissionconfirmforstudent'] = '¿Está seguro de querer eliminar el envío para {$a}?';
$string['removesubmissionconfirmforstudentwithtimelimit'] = '¿Está seguro de querer eliminar el envío para {$a}? Por favor tenga en cuenta que esto no reiniciará el límite de tiempo del estudiante. Usted puede darle más tiempo al añadir una anulación de límite de tiempo al usuario.';
$string['removesubmissionconfirmwithtimelimit'] = '¿Está seguro de querer eliminar el envío para {$a}? Por favor tenga en cuenta que esto no reiniciará su límite de tiempo.';
$string['removesubmissionforstudent'] = 'Quitar envío para estudiante: (id={$a->id}, fullname={$a->fullname}).';
...
$string['requireallteammemberssubmit_help'] = 'Esta configuración debe ser usada junto con la configuración en envío para \'Requerir que los estudiantes opriman el botón \'enviar\'\'.

Si se habilita, todos los miembros del grupo de estudiantes deben elegir el botón de envío para esta tarea antes de que se considere como enviada la tarea del grupo. Si se deshabilita, se considerará como enviada la tarea del grupo tan pronto alguno de los estudiantes del grupo elija el botón de envío.';
...
$string['sendstudentnotifications_help'] = 'Si se habilita, los estudiantes recibirán un mensaje acerca de la retroalimentación o calificación actualizada. Si la tarea usa un flujograma para calificar, o las calificaciones estuvieran ocultas en el reporte del calificador, entonces  las notificaciones no serán enviadas hasta que la calificación sea \'Liberada\'.';
$string['sendstudentnotificationsdefault'] = 'Ajuste predeterminado para \'Notificar a estudiantes\'';
$string['sendstudentnotificationsdefault_help'] = 'Cuando se califica a cada estudiante, ¿debería de ser activada  la casilla de verificación "Notificar a estudiantes" de forma predeterminada?';
...
$string['submissionattachments'] = 'Solamente mostrar archivos durante envío';
$string['submissionattachments_help'] = 'Active la casilla para mostrar archivos solamente en la pantalla de envío. En caso contrario, los archivos serán mostrados tanto en las pantallas de tarea como en la de envío.';
...
$string['submissionstatementrequired'] = 'A usted se le pide que esté de acuerdo con esta declaratoria antes de que pueda enviar.';
...
$string['submittedovertime'] = 'La tarea fue enviada {$a} después del límite de tiempo';
$string['submittedundertime'] = 'La tarea fue enviada {$a} antes del límite de tiempo';
...
$string['timelimit_help'] = 'Si se habilita, el límite de tiempo es mostrado en la página de la tarea y un cronómetro descendente es mostrado durante la tarea.';
$string['timelimitnotenabled'] = 'No está establecido límite de tiempo para Tarea.';
$string['timelimitpassed'] = 'Ha expirado el tiempo límite';
