...
/**
 * Strings for component 'cache', language 'es_mx', version '4.4'.
 *
 * @package     cache
 * @category    string
...
$string['cachedef_coursesectionspreferences'] = 'Preferencias de sección del curso';
...
$string['cachedef_h5p_library_files'] = 'Archivos de biblioteca H5P';
...
$string['cachedef_moodlenet_usercanshare'] = 'Los usuarios pueden compartir recursos a MoodleNet';
...
$string['cachedef_theme_usedincontext'] = 'Un tema ha sido usado en contexto para sobre-escribir el tema predeterminado';
