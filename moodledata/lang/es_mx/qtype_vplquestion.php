...
$string['cfg:deletevplsubmissions_help'] = 'Si los envíos de las preguntas VPL realizados en VPL deben descartarse o no en la evaluación de las pregunt';
...
$string['gradetypeerror'] = 'Parece que la evaluación resultó en una calificación no-numérica: {$a}';
