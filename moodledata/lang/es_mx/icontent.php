...
/**
 * Strings for component 'icontent', language 'es_mx', version '4.4'.
 *
 * @package     icontent
 * @category    string
...
$string['addafter'] = 'Añadir nueva página';
$string['addnewpage'] = 'Añadir nueva página';
$string['addquestion'] = 'Añadir nueva pregunta';
...
$string['bordercolorpagehelp_help'] = 'Haga clic en el campo y elija el color predeterminado para los contornos de cada página.';
...
$string['confpagenotedelete'] = '<i class="fa fa-exclamation-triangle"></i> ¿Está seguro de querer eliminar esta nota y todas las resuestas? <span class="label label-warning">{$a} respuesta(s)</span>';
$string['copyright'] = 'Derechos reservados';
$string['copyright_help'] = 'Espacio reservado para añadir los créditos relacionados con los derechos reservados.';
$string['coverpage'] = 'Portada';
$string['coverpage_help'] = 'Habilitar para crear una portada para el contenido a presentar. Si elige esta opción, agregue una breve descripción en el campo de contenido. Esta descripción aparecerá en la portada. Si la descripción contiene más de 500 caracteres, se agregará un botón de [leer más].';
...
$string['doubtandnotes'] = 'Sus notas y preguntas';
$string['doubts'] = 'Preguntas';
$string['doubtstotutor'] = 'Preguntas enviadas al tutor';
$string['doubttutor'] = 'Solamente preguntarle al tutor';
$string['edit'] = 'Editar';
...
$string['evaluative_help'] = 'Si Usted habilita esta característica, se vuelve un ítem evaluativo.';
$string['eventnotecreated'] = 'Nota creada';
$string['eventnotedeleted'] = 'Nota eliminada';
$string['eventnotelikecreated'] = 'Nota como creada';
$string['eventnotelikedeleted'] = 'Nota como eliminada';
...
$string['eventquestiontoevaluatecreated'] = 'Evaluación manual de preguntas';
...
$string['expandquestionsarea_help'] = 'Activar para mostrar el área de preguntas de forma expandida.';
$string['featured'] = 'Visible';
$string['fluid'] = 'Fluído';
$string['goback'] = 'Último';
...
$string['icontent:checkboxdoubttutornotes'] = 'Pregunta para el tutor';
$string['icontent:checkboxfeaturednotes'] = 'Marcar notas como visibles';
...
$string['icontent:manage'] = 'Gestionar contenido interactivo';
...
$string['icontent:view'] = 'Ver contenido interactivo';
...
$string['usemaxgrade_help'] = 'Si habilita este elemento para evaluación, usted puede informar la calificación más alta disponible en esta actividad.';
