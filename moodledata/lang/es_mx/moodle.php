...
/**
 * Strings for component 'moodle', language 'es_mx', version '4.4'.
 *
 * @package     moodle
 * @category    string
...
$string['addinganewto'] = 'Añadiendo un nuevo (una nueva) {$a->what} a {$a->to}';
...
* Actividad única - El curso contiene una única actividad o recurso.
...
$string['markedthistopic'] = 'Esta sección está resaltada por ser la sección actual';
$string['markthistopic'] = 'Resaltar esta sección por ser la actual';
...
Se le ha creado una nueva cuenta para usted en \'{$a->sitename}\' y se le ha asignado una nueva contraseña temporal.

La información para ingresar es:
   usuario : {$a->username}
   contraseña: {$a->newpassword}
         (deberá cambiar su contraseña
         cuando ingrese por primera vez)

Para comenzar a usar \'{$a->sitename}\', ingrese en
   {$a->link}
...
$string['resetinfo'] = 'Eliminar todos los datos del usuario y reiniciar este curso a su estado original, conservando actividades y configuraciones intactas.';
...
$string['viewresults'] = 'Ver resultados para {$a}';
$string['views'] = 'Vistas';
