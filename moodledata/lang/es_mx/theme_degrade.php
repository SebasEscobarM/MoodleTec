...
/**
 * Strings for component 'theme_degrade', language 'es_mx', version '4.4'.
 *
...
$string['fontfamily'] = 'Font del sitio';
$string['fontfamily_desc'] = 'Elige el font que deseas utilizar en tu Moodle';
...
$string['footer_frontpage_blockcourses_text_desc'] = '¡Añade un texto acerca de "{$a}"!';
...
$string['frontpage_about_logo_desc'] = 'Si se establece, se utilizará este logo aquí en lugar del logo superior.<br> Vacío usa el logo superior.';
...
$string['logo_write'] = 'Logotipo del menú superior al desplazarse';
...
$string['settings_top_heading'] = 'Menú Principal';
