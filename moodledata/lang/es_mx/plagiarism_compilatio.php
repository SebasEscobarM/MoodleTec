...
$string['cron_check'] = 'Los trabajos agendados del plugin send_files han sido ejecutados en {$a} por última vez.';
$string['cron_check_never_called'] = 'Los trabajos agendados del send_files nunca han sido ejecutados desde la activación del plugin. Podrían estar mal configurados en su servidor.';
$string['cron_check_not_ok'] = 'Los trabajos agendados del plugin send_files NO han sido ejecutados en la última hora.';
