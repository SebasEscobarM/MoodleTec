...
/**
 * Strings for component 'simplecertificate', language 'es_mx', version '4.4'.
 *
...
$string['certificatepath'] = 'Ruta al certificado';
$string['certificatepath_help'] = 'Solo son permitidos archivos .CRT';
...
<li>{COURSENAME} -> Nombre completo del curso (o un nombre de curso alterno Definido)</li>
<li>{GRADE} -> Calificación formateada</li>
<li>{DATE} -> Fecha formateada</li>
<li>{OUTCOME} -> Competencias</li>
<li>{TEACHERS} -> Lista de profesores</li>
<li>{IDNUMBER} -> N{umero ID del usuarior</li>
<li>{FIRSTNAME} -> Nombre(s) del usuario</li>
<li>{LASTNAME} -> Apellido(s) del usuario</li>
<li>{EMAIL} -> E-mail del usuario</li>
<li>{PHONE1} ->  Teléfono 1°  del usuario</li>
<li>{PHONE2} -> Teléfono 2°  del usuario</li>
<li>{INSTITUTION} -> Institución del usuario</li>
<li>{DEPARTMENT} -> Departmento del usuario</li>
<li>{ADDRESS} -> Dirección del usuario</li>
<li>{CITY} -> Ciudad del usuario</li>
<li>{COUNTRY} -> País</li>
<li>{CERTIFICATECODE} -> Texto del código único del certificado</li>
<li>{USERROLENAME} -> Nombre del usuario en el curso</li>
<li>{TIMESTART} -> Fecha de inicio de inscripción en el curso</li>
<li>{USERIMAGE} -> Imagen del perfil del usuario</li>
<li>{USERRESULTS} -> Resultados del usuario (calificación) en otras actividades del curso</li>
<li>{PROFILE_xxxx} -> Campos personalizados del perfil del usuario</li>
</ul>
...
$string['datefmt_help'] = 'Elija un formato de fecha PHP válido (<a href="http://www.php.net/manual/en/function.strftime.php"> Date Formats</a>). O déjelo vacío para usar el formato del idioma elegido por el usuario.';
$string['defaultcertificatetextx'] = 'Posición de Texto Horizontal Predeterminada';
$string['defaultcertificatetexty'] = 'Posición de Texto Vertical por defecto';
$string['defaultcodex'] = 'Posición Horizontal Predeterminada del Código QR (Respuesta Rápida)';
...
$string['emailoncompletion'] = 'Enviar Email al completar el curso';
...
$string['emailteachers_help'] = 'Si se habilita, entonces los profesores serán alertados con un Email cada vez que un estudiante reciba un certificado.';
...
$string['invalidfilterfield'] = 'Campo de filtro inválido';
...
$string['multipdf'] = 'Descargar certificados en un archivo ZIP';
$string['neverdeleteoption'] = 'Nunca eliminar';
$string['nocertificatesissued'] = 'No hay certificados que hayan sido emitidos';
$string['nodelivering'] = 'No enviado, el usuario recibirá este certificado empleando otras vías';
$string['nohavecertificates'] = 'Usted aun no tiene certificados';
...
$string['privacy:metadata:simplecertificate_issues'] = 'El plugin de certificado simple almacena información acerca de certificados emitidos.';
$string['privacy:metadata:simplecertificate_issues:certificateid'] = 'La ID del certificado emitido.';
...
$string['privacy:metadata:simplecertificate_issues:coursename'] = 'El nombre del curso para el que fue emitido el certificado.';
$string['privacy:metadata:simplecertificate_issues:haschange'] = 'Indica si el certificado ha sido cambiado.';
$string['privacy:metadata:simplecertificate_issues:pathnamehash'] = 'El hash del archivo del certificado';
$string['privacy:metadata:simplecertificate_issues:timecreated'] = 'El sello de tiempo de cuando fue emitido el certificado.';
$string['privacy:metadata:simplecertificate_issues:timedeleted'] = 'El sello de tiempo de cuando fue eliminado el certificado.';
$string['privacy:metadata:simplecertificate_issues:userid'] = 'LA ID del usuario que recibió el certificado.';
...
$string['receiveddate'] = 'Fecha Emitido';
