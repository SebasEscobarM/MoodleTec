...
/**
 * Strings for component 'admin', language 'es_mx', version '4.4'.
 *
 * @package     admin
 * @category    string
...
$string['accountlocked'] = 'Su cuenta ha sido bloqueada. Se ha enviado un  enlace para des-bloquearla vía E-mail.';
$string['accounts'] = 'Cuentas';
$string['accountunlocked'] = 'Su cuenta ha sido des-bloqueada. Ahora usted puede ingresar.';
...
$string['allowbeforeblockdesc'] = 'De forma predeterminada, se procesará en primer lugar la lista de IPs bloqueadas; si la opción se activa, la lista de IPs permitidas se procesará antes que la lista bloqueada.';
...
$string['asyncbackupdisabled'] = 'Su sitio actualmente está configurado para usar respaldos sincrónicos.  Los respaldos asincrónicos proporcionan una mejor experiencia para el usuario, permitiendo que el usuario haga otras operaciones mientra un respaldo o una restauración está en progreso. Los respaldos asincrónicos serán habilitados para todos los sitios a partir de Moodle LMS 4.5 LTS. Los respaldos sincrónicos serán eliminados de Moodle LMS en la versión después de la 4.5 LTS.';
...
$string['availabletoanyone'] = 'Disponible para todos los que visiten el sitio.';
...
$string['blockunprotectblock'] = 'Des-proteger instancias de {$a}';
$string['blockunprotected'] = '{$a} instancias de bloque están des-protegidas.';
...
$string['cacheapplicationhelp'] = 'Los elementos cacheados se comparten entre todos  los usuarios y expiran por una TTL determinada';
...
$string['calendartype_desc'] = 'Elija un tipo de calendario predeterminado para todo el sitio. Esta configuración no puede anularse en las configuraciones del curso, ni por usuarios en su perfil personal.';
...
$string['cliupgradecompletenomaintenanceupgrade'] = 'Para purgar las cachés restantes después del corte de tráfico del usuario a código nuevo:
...
Usted debería ejecutar estas purgas solas, con un hueco entre comandos, para reducir los picos de carga sobre el servidor web.';
$string['cliupgradedefault'] = 'Nueva configuración: {$a}';
$string['cliupgradedefaultheading'] = 'Configurando los nuevos valores predeterminados';
...
$string['cliupgrademaintenancenotrequired'] = 'Esta actualización NO RESULTARÁ en modo de mantenimiento para usuarios.';
$string['cliupgrademaintenancerequired'] = 'Esta actualización RESULTARÁ en modo de mantenimiento para usuarios.';
...
$string['cliupgradesetlock'] = 'La actualización ha sido bloqueda a solamente ejecución de la Interfaz por Línea de Comandos.';
$string['cliupgradeunsetlock'] = 'El bloqueo de la actualización de ejecución por Interfaz de Línea de Comandos ha sido eliminado.';
...
$string['condifmodeditdefaults'] = 'Los valores que fije aquí definen los valores predeterminados que se usan cuando Usted crea una actividad nueva.';
...
$string['configallowassign'] = 'Para cada rol en la columna de la izquierda, seleccionar cuales roles ellos pueden asignar a otros.';
...
$string['configallowguestmymoodle'] = 'Si se habilita, los invitados podrán tener acceso al Tablero. De lo contrario los invitados son re-direccionados a la página de inicio del sitio.';
$string['configallowobjectembed'] = 'Como medida de seguridad, los usuarios con el rol de estudiante no tienen permitido incrustar objetos multimedia  dentro de textos utilizando las marcas (tags) EMBED y OBJECT en HTML, aunque los multimedios se pueden seguir mostrando usando el filtro de plugins multimedia.  Si usted desea permitir estas marcas (tags) entonces active esta opción.';
...
$string['configallowoverride2'] = 'Para cada rol en la columna de la izquierda, seleccionar para cuales roles ellos pueden configurales anulaciones..<br />Los usuarios deben tener la capacidad \'moodle/role:override\' o la capacidad \'moodle/role:safeoverride\' permitidas.';
$string['configallowswitch'] = 'Para cada rol en la columna de la izquierda, seleccionar a cuales roles ellos pueden cambiarse..<br />Los usuarios también deben tener la capacidad moodle/role:switchroles.\' permitida.';
...
$string['configallowview'] = 'Para cada rol en la columna de la izquierda, seleccionar cuales roles ellos pueden ver, buscar y filtrar por.';
$string['configallusersaresitestudents'] = 'En lo que concierne a las actividades de la página de inicio del sitio, ¿deberían TODOS los usuarios ser considerados como estudiantes? Si la respuesta es \'Sí\', cualquier usuario con cuenta confirmada podrá participar como estudiante en tales actividades. Si la respuesta es \'No\', sólo los usuarios que ya participan en al menos un curso podrán tomar parte en estas actividades. Sólo los administradores y profesores especialmente asignados pueden actuar como profesores para las actividades en la página de inicio del sitio.';
...
$string['configautolang'] = 'Detectar idioma predeterminado desde el ajuste del navegador. Si está deshabilitado, se utiliza el idioma predeterminado del sitio.';
...
$string['configautologinguests'] = '¿Los visitantes deberían de ser ingresados como invitados automáticamente cuando entran a los cursos con acceso de invitado?';
...
$string['configcustommenuitems'] = 'Puede diseñar aquí un menú personalizado. Ingrese cada elemento del menú en una nueva línea con el formato:  texto del menú, un enlace URL (opcional, no se usa para un elemento del menú superior con sub-elementos), un título de una herramientita (opcional) y un código de idioma o lista separada por comas de códigos de idiomas (opcionales, para mostrar la línea solamente a usuarios del idioma seleccionado), separados por el caracter de línea vertical | (AltGr + 1). Las líneas que comiencen con un guion aparecerán como elementos de menú en el menú del nivel superior anterior y ### hace un divisor. Por ejemplo:
<pre>
Cursos
...
Mobile app|https://example.org/app|Descargar nuestra app
</pre>';
$string['configcustomusermenuitems'] = 'Usted puede configurar los contenidos del menú del usuario (con excepción del enlace para salirse, el cual es añadido automáticamente). Cada línea está separada por caracteres de | y consiste de 1) una cadena de texto en el formato de  "nombredecadenadeidioma, nombredelcomponente" o como texto simple, 2) una URL. Pueden usarse divisores al añadir una línea de uno o más caracteres # en donde se quiera.';
...
$string['configdebugvalidators'] = 'Activar si quiere disponer de enlaces a servidores externos de validación en el pie de página. Es posible que necesite crear un nuevo usuario con el   <em>w3cvalidator</em>  para nombre de usurio, y permitir el acceso de invitados. Estos cambios pueden facilitar el acceso no autorizado al servidor, ¡no lo haga en los sitios de producción!';
$string['configdefaulthomepage'] = '¿A cual página deberían ser redireccionados los usuarios después de iniciar sesión en el sitio? La configuración también determina el primer enlace en la navegación para usuarios de temas basados en el tema Clásico.';
...
$string['configdefaultuserroleid'] = 'A todos los usuarios que hayan iniciado sesión se les asignarán las capacidades del rol que usted especifique aquí, en el nivel del sitio, ADEMÁS de cualesquiera otros roles que puedan tener. El rol por defecto es el de Usuario Autenticado (Authenticated user). Tenga en cuenta que esto no entrará en conflicto con otros roles que el usuario tenga a menos que Usted prohíba capacidades (prohibit capabilities). Esto simplemente asegura que todos los usuarios tengan capacidades que no son asignables a nivel de curso (por ejemplo: enviar entradas al blog, gestionar su propio calendario, etc.).';
...
$string['configdocroot'] = 'Define la ruta a Moodle Docs para proporcionar documentación específica según el contexto, mediante enlaces hacia \'Documentación para esta página\' en el pie de cada página. Si deja vacío este campo, los enlaces no serán mostrados.';
$string['configdoctonewwindow'] = 'Si habilita esta opción, entonces los enlaces a Moodle Docs se mostrarán en una nueva ventana.';
$string['configduration_high'] = 'Este valor es demasiado alto. el valor máximo es {$a}.';
...
$string['configenablewsdocumentation'] = 'Habilitar la auto-generación de documentación de servicios web. Un usuario puede tener acceso a su propia documentación en su página de llaves de seguridad {$a}. Solo se muestra la documentación de los protocolos habilitados.';
...
$string['configextendedusernamechars'] = 'Si se habilita, los nombres de usuario pueden incluir cualquier caracter excepto letras MAYÚSCULAS. De lo contrario, solamente están permitidas letras en minúsculas, guion bajo (_), guion (-), símbolo de punto (.) o de arroba (@). Tenga en cuenta que en México es frecuente que las computadoras confundan la disposición del teclado Latinoamericano con Español, lo que comúnmente resulta en acentos equivocados (à en lugar de á).';
...
$string['configfilternavigationwithsystemcontext'] = 'El uso normal del filtrado está ligado al contexto en donde es usado (por ejemplo, contexto del curso), pero para la navegación del sitio, el hacer filtrar todo explícitamente con el contexto del sitio puede producir mejoras del desempeño cuando se usa filtrado de "contenido y encabezados".';
...
$string['configforcelogin'] = 'Normalmente la página de inicio del sitio y las listas de los cursos (pero no los cursos) pueden ser leídos por cualquiera sin necesidad de iniciar sesión en el sitio. Si desea forzar a los visitantes a iniciar sesión en el sitio antes de poder ver CUALQUIER CONTENIDO en el sitio, entonces debería activar esta configuración.';
$string['configforceloginforprofiles'] = 'Esta opción obliga a ingresar al sitio (iniciar sesión) con una cuenta válida (no como invitado) antes de poder ver la página del perfil de cualquier usuario. Si deshabilita esta opción puede darse el caso de que algunos usuarios publiquen anuncios (spam) u otro contenido inapropiado en sus perfiles y este contenido será visible para todo el mundo.';
$string['configfrontpage'] = 'Los elementos seleccionados arriba se mostrarán en la página de inicio del sitio.';
$string['configfrontpagecourselimit'] = 'Número máximo de cursos';
$string['configfrontpagecourselimithelp'] = 'Número máximo de cursos a mostrarse en la página de inicio del sitio en los listados de cursos.';
$string['configfrontpageloggedin'] = 'Los elementos seleccionados se mostrarán en la página de inicio del sitio cuando un usuario haya iniciado sesión.';
$string['configfullnamedisplay'] = 'Esto define como son mostrados los nombres cuando se muestren completos. El valor predeterminado, "language" (idioma), deja que lo decida la cadena de caracteres "fullnamedisplay" en el paquete actual de idioma. Algunos idiomas tienen diferentes convenciones para mostrar nombres.

Para la mayoría de los sitios mono-lingues la configuración más eficiente es "firstname lastname", pero usted podría elegir ocultar completamente los apellidos (lastname). Los sustituíbles (placeholders) que se pueden usar son: firstname, lastname, firstnamephonetic, lastnamephonetic, middlename, y alternatename
...
$string['configgradeexportdefault'] = 'Elegir cuál formato de exportación de Libro de calificaciones es su método predeterminado para exportar calificaciones.';
...
(a) No se pide a los usuarios un número de ID para nada,
(b) Se les pide un número de ID pero pueden dejarlo en blanco, o
(c) Se les pide un número de ID y no pueden dejarlo en blanco.
Si se proporciona, el número de ID del Usuario se muestra en su Perfil.';
...
$string['configintrosite'] = 'Esta página le permite configurar la página de inicio del sitio y dar un nombre a su nuevo sitio. Puede volver aquí más adelante y cambiar estos ajustes en cualquier momento usando los menús de Administración.';
...
$string['confignotloggedinroleid'] = 'Los usuarios que no hayan iniciado sesión en el sitio serán tratados como si tuvieran este rol en el contexto del sitio. \'Invitado\' es casi siempre lo que usted quiere aquí, pero quizás desearía crear roles que sean más o menos restrictivos. Cosas como poner mensajes requieren que el usuario inicie sesión adecuadamente';
$string['configopentowebcrawlers'] = 'Si activa esta opción, se permitirá a los motores de búsqueda (como Google) entrar al sitio como Invitado. Además, quien acceda al sitio vía un motor de búsqueda ingresará automáticamente como Invitado. Tenga en cuenta que esta opción sólo proporciona acceso transparente a los cursos que ya permiten el acceso a invitados.';
...
$string['configprofileroles'] = 'Roles que están enlistados en los perfiles de usuario y en la página de participantes.';
...
$string['configprotectusernames'] = 'Si se habilita, no se mostrarán pistas que permitan adivinar  el usuario o la dirección de Email en el formato de contraseña olvidada .';
...
$string['configproxyfixunsafe_help'] = 'Esto intenta arreglar llamadas internas que no pasan por el proxy al añadir al Agente de Usuario de MoodleBox y usar el proxy.';
...
$string['configproxylogunsafe_help'] = 'Esto intenta escribir llamadas internas que no pasan por el proxy y que si deberìan.';
...
$string['configrecaptchapublickey'] = 'Cadena de caracteres (clave del sitio) usados para mostrar el elemento reCAPTCHA en los formatos de pre-inscripción y de soporte del sitio. Las claves ReCAPTCHA pueden obtenerse de  <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configservicespage'] = 'Escriba la URL de una pagina de servicios y soporte o deje vacío para enlazar a servicios Moodle en moodle.com. El mensaje solamente es mostrado para administradores del sitio.';
...
$string['configsessiontimeoutwarning'] = 'Si las personas que iniciaron sesión en este sitio están inactivas  por mucho tiempo (sin  cargar páginas) entonces son advertidas de que su sesión está a punto de terminar. Esta variable especifica que tan largo debería ser este tiempo.';
...
$string['configsmtpoauthservice'] = 'Seleccionar el servicio OAuth 2 que está configurado para hablarle al servidor SMTP. Si el servicio aun no existe, usted necesitará crearlo. Por favor tenga en cuenta que usted necesita configurar el Tipo de Autenticación SMTP a  XOAUTH2.';
$string['configsmtpsecure'] = 'Si el servidor SMTP requiere conexión segura, especifique el tipo de protocolo correcto.';
$string['configsmtpuser'] = 'Si antes ha especificado un servidor SMTP, y el servidor requiere autenticación, escriba aquí el usuario y la contraseña.';
...
$string['configsupportavailability'] = 'Determina quién tiene acceso para ponerse en contacto con el soporte del sitio desde el pie de página.';
$string['configsupportemail'] = 'Si SMPT estuviera configurado en este sitio, y no estuviera configurada una página de soporte, esta dirección Email recibirá los mensajes enviados mediante el formato de soporte. Si falla el envío, la dirección de Email será mostrada a los usuarios ingresados (que iniciaron sesión).';
$string['configsupportname'] = 'El nombre de la persona u otra entidad  que ofrece soporte por medio del formato para soporte o la página para soporte.';
$string['configsupportpage'] = 'Escribir la URL de una página de soporte o dejar en blanco para enlazar hacia un formato  de contacto. El enlace es mostrado en el pie de página del sitio..';
...
$string['confirmdeletecomments'] = '¿Está seguro de querer eliminar los comentarios seleccionados?';
$string['confirmed'] = 'Confirmado';
$string['contactsitesupport'] = 'Ponerse en contacto con soporte del sitio';
...
$string['coursecolorheading_desc'] = 'Cualquier curso sin una imagen configurada en las configuraciones del curso será mostrada en la página de Mis cursos con una tarjeta del curso con un patrón de colores. Los colores usados en el patrón pueden ser especificados debajo.';
...
$string['coursecreationguide'] = 'URL de guía de creación de curso Moodle';
$string['coursecreationguide_help'] = 'Define la ruta hacia la guía de Inicio Rápido con videos cortos y sugerencias generales para crear cursos. Un enlace hacia la guía es mostrado en la página de Mis cursos cuando no hay cursos para mostrar. Solamente usuarios con la capacidad para crear cursos verán el enlace.';
...
$string['courserequestnotifyemail'] = 'El usuario {$a->user} solicitó un nuevo curso en <a href="{$a->link}">{$a->link}</a>.';
...
$string['cron_keepalive'] = 'Conservar vivo';
$string['cron_keepalive_desc'] = 'El lapso de tiempo para continuar sondeando trabajos adicionales. Esta configuración es para asegurase de que CRON está ejecutando siempre. Si usted usa ejecutores dedicados de trabajo, configurar a 0. En caso contrario, configurar a un valor similar al límite de concurrencia de trabajo ad-hoc. Evite los tiempos más largos. El tiempo máximo es de 15 minutos.';
...
$string['customusermenuitems'] = 'Elementos del menú del usuario';
...
$string['dbprefixtoolong'] = 'El prefijo de la base de datos de su sitio ($CFG->prefix) es demasiado largo ({$a->current} caracteres). El número máximo de caracteres permitidos es {$a->maximum}.';
...
$string['debugtemplateinfo'] = 'Mostrar información de plantilla';
$string['debugtemplateinfo_desc'] = 'Si se habilita, las plantillas usadas para renderizar son mostradas como comentarios en el HTML de la página. Después de cambiar esta configuración, usted necesita purgar cachés. Use para depuración temporal solamente, porque produce errores de validación de HTML y podría romper scripts de las páginas. ¡También puede romper funcionalidad!';
$string['debugvalidators'] = 'Mostrar enlaces de validación';
$string['defaultcity'] = 'Ciudad predeterminada';
$string['defaultcity_help'] = 'La ciudad introducida aquí será la ciudad predeterminada al crear nuevas cuentas de usuario.';
$string['defaultformatnotset'] = 'Error al determinar el formato predeterminado del curso. Por favor revise las configuraciones del sitio.';
$string['defaulthomepage'] = 'Página de inicio para los usuarios';
$string['defaultrequestcategory'] = 'Categoría predetrminada de las solicitudes de curso';
$string['defaultsettinginfo'] = 'Valor predeterminado: {$a}';
$string['defaultuserroleid'] = 'Rol predeterminado de todos los usuarios';
...
$string['docroot'] = 'Raíz de documentos Moodle Docs';
...
$string['enablecommunicationsubsystem'] = 'Habilitar proveedores de comunicaciones';
$string['enablecommunicationsubsystem_desc'] = 'Permitir integración con proveedores de comunicación como Matrix, para que los profesores y estudiantes puedan comunicarse más fácilmente.  Usted puede gestionar estas integraciones en <a href="settings.php?section=managecommunicationproviders">Plugins</a>.';
...
$string['enabledashboard'] = 'Habilitar Tablero';
$string['enabledashboard_help'] = 'El Tablero muestra de forma predeterminada la Línea del tiempo, el Calendario y los Elementos accedidos recientemente. Usted puede configurar  un diferente Tablero predeterminado para todos y permitirle a los usuarios el personalizar su propio Tablero. Si se deshabilita, usted necesitará configurar la \'Página inicial para usuarios\' a un valor diferente de Tablero.';
...
$string['enablepdfexportfont'] = 'Habilitar fonts de PDF';
...
$string['enroladminnewcourse'] = 'Auto-inscribir administrador en nuevos cursos';
$string['enroladminnewcourse_help'] = 'Cuando un administrador añade un nuevo curso ¿debería de ser inscrito automáticamente y asignado el rol de creador en el nuevo curso?';
...
$string['entitytasklog'] = 'Bitácora de trabajo';
...
$string['environmentmariadbwrongdbtype'] = 'Problema con $CFG->dbtype: Usted necesita cambiarla en su archivo config.php de \'mysqli\' a \'mariadb\'.';
...
$string['environmentrecommendcustomcheck'] = 'Si esta comprobación falla, esto indica un problema potencial';
...
$string['environmentshouldfixcustomcheck'] = 'debería estar habilitado para los mejores resultados';
...
$string['extendedusernamechars'] = 'Permitir caracteres extendidos en nombres de usuarios';
...
$string['favicon_desc'] = 'El favicon es mostrado junto al título de la página en la pestaña del navegador. Un favicon Moodle es mostrado en caso de que no sea proporcionado un favicon personalizado.';
...
$string['filternavigationwithsystemcontext'] = 'Filtrar navegación con contexto del sistema';
...
$string['forceloginforprofileimage'] = 'Forzar a los usuarios a iniciar sesión para ver imágenes de usuarios';
$string['forceloginforprofileimage_help'] = 'Si se habilita, los usuarios deben iniciar sesión para ver las imágenes del perfil y la imagen predeterminada de usuario será empleada en todos los correos electrónicos de notificación.';
$string['forceloginforprofiles'] = 'Forzar a los usuarios a iniciar sesión para ver perfiles';
...
$string['frontpage'] = 'Página de inicio del sitio';
$string['frontpagebackup'] = 'Respaldo de la página de inicio del sitio';
$string['frontpagedefaultrole'] = 'Rol por defecto en la página de inicio del sitio';
$string['frontpagefilters'] = 'Filtros de la página de inicio del sitio';
$string['frontpageloggedin'] = 'Elementos de la página de inicio del sitio al iniciar sesión';
$string['frontpageoverrides'] = 'Anulaciones de permisos en la página de inicio del sitio';
$string['frontpagequestions'] = 'Preguntas de la página de inicio del sitio';
$string['frontpagerestore'] = 'Restauración de la página de inicio del sitio';
$string['frontpageroles'] = 'Roles de la página de inicio del sitio';
...
$string['gradeexportdefault'] = 'Método predeterminado para exportar calificaciones';
...
$string['hookcallbacknotcallable'] = 'La retrollamada no es llamable. esto podría ser porque la clase o el método no existen, o porque el método no es público.';
$string['hookcallbacks'] = 'Retrollamadas';
$string['hookcallbacks_help'] = 'La lista de retrollamadas que serán llamadas cuando el hok sea despachado.

El orden mostrado es el orden en el cual las retrollamadas son llamadas.

Una retrollamada con una prioridad más alta será llamada antes que una con prioridad más baja.';
$string['hookclassmissing'] = 'Clase de hook no encontrada';
$string['hookclassmissing_desc'] = 'El agente descubridor de hook ha regresado una clase que no existe.';
$string['hookconfigoverride'] = 'Anulada';
$string['hookconfigoverride_help'] = 'La definición de esta retrollamada ha sido anulada en el archivo config.php de la configuración del sitio';
$string['hookdeprecates'] = 'Retrollamadas deprecadas';
$string['hookdescription'] = 'Descripción';
$string['hookdescriptionmissing'] = 'Hook no tiene un método de descripción';
$string['hookname'] = 'Hook';
$string['hooksoverview'] = 'Vista general de hooks';
$string['hookunknown'] = 'Hook no encontrado';
$string['hookunknown_desc'] = 'El objeto al cual escucha esta retrollamada no está disponible. Podría haber sido removido o renombrado, o estar no disponible en esta versión de Moodle.';
...
$string['invaliduserchangeme'] = 'El nombre de usuario "changeme" es reservado: no puede crear una cuenta con ese nombre (que significa "cámbiame").';
...
$string['iplookupinfo'] = 'Moodle utiliza el servidor gratuito en línea NetGeo (The Internet Geographic Database) para buscar la ubicación de las direcciones IP. Desafortunadamente, ha cesado el mantenimiento de esta base de datos, y puede devolver datos incorrectos. Se recomienda instalar una copia local de la base de datos gratuita GeoLite2 City de MaxMind.<br />.
Si es proporcionada una clave Google Maps API V3, la ubicación de la dirección IP es mostrada usando Google Maps. Usted necesita  tener una cuenta Google y solicitar una clave API de Google Maps. Si no es proporcionada una clave Google Maps API V3, la ubicación de la dirección IP es mostrada usando OpenStreetMap.';
...
$string['lockoutemailbody'] = 'Su cuenta con nombre de usuario {$a->username} en el servidor \'{$a->sitename}\' fue bloqueada después de haber tenido múltiples intentos fallidos para entrar.
...
$string['logguests_help'] = 'Esta configuración habilita el registro de acciones para cuentas de invitados o usuarios que no han iniciado sesión. En determinados sitios se podría desactivar esta opción por razones de rendimiento. Se recomienda mantener esta opción habilitada en los sitios en producción.';
...
$string['logocompact_desc'] = 'Una versión compacta del mismo logo de arriba, como por ejemplo, un emblema, escudo o ícono. La imagen debe de ser clara, aun en tamaños pequeños.';
...
$string['manageformatsgotosettings'] = 'El formato predeterminado puede cambiarse en {$a}';
$string['managelang'] = 'Administrar';
$string['manageqbanks'] = 'Gestionar plugins del banco de preguntas';
...
$string['moodlebrandedapp_help'] = '<p>La App Moodle de marca personalizada tiene toda la funcionalidad de nuestra App Mobile gratuita para Moodle combinada con sus características de su marca personalizada propia.</p>
<a href="https://moodle.com/branded-app">Acerca de la App Moodle de marca</a>';
$string['moodlebrandedappreference'] = 'Alternativamente, obtenga una  <a href="https://moodle.com/branded-app/">Branded Moodle app (App Moodle de marca personalizada)</a> con su propio estilo de su marca personalizada.';
...
$string['mydashboard'] = 'Tablero predetrminado del sistema';
$string['mymoodle'] = 'Tablero';
$string['mypage'] = 'Página predeterminada del Tablero';
$string['mypagelocked'] = 'Bloquear página predeterminada';
$string['myprofile'] = 'Página predeterminada de perfil';
...
$string['navshowfrontpagemods'] = 'Mostrar las actividades de la página de inicio del sitio en la navegación';
$string['navshowfrontpagemods_help'] = 'Si se habilita, las actividades de la página de inicio del sitio se mostrarán en la navegación debajo de las páginas del sitio. Esta configuración solamente aplica en temas basados en Classic.';
...
$string['navsortmycoursessort'] = 'Orden de cursos en bloque de Navegación';
$string['navsortmycoursessort_help'] = '¿Se deberían enlistan los cursos  en el orden elegido en Administración del sitio > Cursos > Gestionar cursos y categorías,  o alfabéticamente por configuración del curso? Esta configuración solamente aplica a temas basados en Classic.';
$string['never'] = 'Nunca';
...
$string['noemaileverwarning'] = '<strong>Nota:</strong> Todos los E-mails salientes han sido  deshabilitados';
...
$string['noteunneededblocks'] = 'Nota: Bloques configurados a mostrarse no estarán enlistados en el menú para \'Añadir un bloque\' en un curso si están especificados en las configuraciones del bloque de \'Bloques innecesarios\'.';
...
$string['oracledatabaseinuse'] = 'El soporte para Oracle DB será eliminado. Moodle versión 4.5 será la última versión con soporte a BasedeDatos de Oracle. Para los detalles, vea el anuncio en moodle.org <a href="https://moodle.org/mod/forum/discuss.php?d=456122">Oracle database support in LMS deprecation</a>.';
...
$string['pathtosassc_help'] = 'Al especificar la ubicación del binario de SassC cambiará al compilador de SASS de la implementación PHP de Moodle a SassC. Vea https://github.com/sass/sassc para más información.';
...
$string['perfdebugdeferred'] = 'Esperando hasta que el script termine de mostrar la depuración del desempeño ...';
...
$string['profiledefaultdata'] = 'Valor predterminado';
...
$string['profilefieldmaxlength_help'] = 'Para usar este campo en la configuración \'Mostrar identidad del usuario\', el límite deben ser 255 caracteres o menos.';
...
$string['profilemenudefaultnotinoptions'] = 'El valor predterminado no está entre las opciones';
...
$string['profileshortnameinvalid'] = 'Este nombre corto solamente puede contener carecteres alfanuméricos (letras y números) o el signo de guion bajo (_).';
...
$string['profilevisible_help'] = '* No visible - Para datos privados solamente visibles por administradores y mánagers
...
$string['protectusernames'] = 'Proteger nombres de usuarios';
$string['proxybypass'] = 'hosts que saltan el proxy';
$string['proxyfixunsafe'] = 'Arreglar llamadas sin proxy';
$string['proxyhost'] = 'host del proxy';
$string['proxylogunsafe'] = 'Escribir llamadas sin proxy';
$string['proxypassword'] = 'Contraseña del proxy';
$string['proxyport'] = 'Puerto proxy';
$string['proxytype'] = 'Tipo de proxy';
$string['proxyuser'] = 'nombre del usuario del proxy';
...
$string['rememberusername_desc'] = 'Activar si desea almacenar las \'cookies\' permanentes con nombres de usuarios durante el ingreso. ¡Las \'cookies\' permanentes se podrían considerar  como riesgo/invasión potencial  para la privacidad del usuario si se utilizan sin su consentimiento!';
$string['replacefrontsearch'] = 'Usado para búsqueda de curso en página de inicio del sitio';
...
$string['resetindentation'] = 'Reiniciar indentación en todo el sitio';
$string['resetindentation_help'] = 'Esto quitará cualquier indentación previamente configurada para cursos en el sitio en {$a->format}.';
$string['resetindentation_title'] = '¿Reiniciar indentación en todo el sitio?';
$string['resetindentationsuccess'] = 'Indentación reiniciada';
...
$string['searchmaxtopresults'] = 'Máximo de resultados superiores';
$string['searchmaxtopresults_desc'] = 'El número máximo de resultados superiores a ser mostrados arriba de los resultados de la búsqueda para contenido del curso, cursos y usuarios.';
...
$string['searchteacherroles_desc'] = 'Seleccionar todos los roles que hacen usuarios con el rol de rankeador más altos en resultados de la búsqueda.';
$string['searchtopresults'] = 'Resultados Superiores';
...
$string['sessioncookie'] = 'Sufijo de las \'cookies\'';
...
$string['sitemaintenanceon'] = 'El sitio está en modo mantenimiento (sólo los administradores pueden iniciar sesión o usar el sitio).';
...
$string['sitemaintenancewarning'] = 'El sitio está en modo mantenimiento (sólo los administradores pueden iniciar sesión). Para ponerlo en funcionamiento de nuevo, <a href="maintenance.php">desactive el modo de mantenimiento</a>.';
...
$string['sitenameintitle'] = 'Incluir nombre del sitio en título de página';
$string['sitenameintitle_help'] = 'Esta configuración añadirá el nombre del sitio al final del título de la página. Es recomendable incluir el nombre del sitio en el título de la página ya que mejorará la accesibilidad al permitirle a los usuarios identificar rápidamente la página en la que están actualmente.';
...
$string['sitepolicyhandlercore'] = 'Preterminado (núcleo)';
$string['sitepolicyhandlerplugin'] = '{$a->name} ({$a->component})';
$string['sitesectionhelp'] = 'Mostrar una sección en la parte superior de la página donde usted puede añadir contenido personalizado.';
...
$string['smallscreensonly'] = 'Pantallas pequeñas solamente';
$string['smtp'] = 'SMTP';
...
$string['supportavailability'] = 'Disponibilidad del soporte';
...
$string['supportpage'] = 'Enlace para ponerse en contacto con soporte del sitio';
...
$string['task_adhoc_failed_retention'] = 'Falló período de retención de trabajo ad hoc';
$string['task_adhoc_failed_retention_desc'] = 'El período máximo que falló en trabajos ad hoc deberían permanecer en la cola una vez que ellos hayan alcanzado su límite de re-intentos.';
...
$string['task_dbreads'] = 'Lecturas a Base de Datos';
$string['task_dbstats'] = 'Base de datos';
$string['task_dbwrites'] = 'Escrituras a Base de Datos';
$string['task_duration'] = 'Duración';
$string['task_endtime'] = 'Hora de término';
...
$string['task_logoutput'] = 'Salida del trabajo';
...
$string['task_status'] = 'Estado del trabajo';
$string['task_status_desc'] = 'El trabajo \'{$a->name}\' está {$a->status}. Para los detalles, vea  {$a->class}{$a->extradescription} en <a href="{$a->gotourl}">Trabajos agendados</a>.';
...
$string['taskautomatedbackup_report'] = 'Reporte de respaldos automatizados';
$string['taskbackupcleanup'] = 'Limpiar bitácoras, archivos y tablas de respaldo';
$string['taskbadgesadhoc'] = 'Otorgar insignia';
$string['taskbadgescron'] = 'Añadir trabajos adhoc para otorgar insignias';
...
$string['tasklockcleanuptask'] = 'Limpiar metadatos ad hoc de trabajos';
...
$string['testoutgoingmailconf_fromemail'] = 'Del nombre de usuario o la dirección Email';
$string['testoutgoingmailconf_fromemail_help'] = 'Este campo emula el enviar el mensaje desde ese usuario, pero el encabezado De usado en el Email que realmente es enviado dependerá de otras configuraciones como por ejemplo allowedemaildomains (dominios Email permitidos)';
$string['testoutgoingmailconf_fromemail_invalid'] = 'Nombre de usuario De o Email inválido. Debe ser un Email válido o un nombre de usuario existente en Moodle.';
$string['testoutgoingmailconf_message'] = 'Este es un mensaje de prueba para confirmar que Usted ha configurado exitosamente sus configuraciones de E-mail saliente del sitio. Enviado:{$a}';
...
$string['themeeditsettingsname'] = 'Editar configuraciones del tema \'{$a}\'';
...
$string['themesettingsadvanced'] = 'Configuraciones avanzadas del tema';
$string['themesettingscustom'] = 'Configuraciones personalizadas del tema';
$string['themesettingsname'] = 'Configuraciones del tema \'{$a}\'';
$string['themeusagereportname'] = 'Reporte de uso del tema \'{$a}\'';
...
$string['unsupportedphpversion7'] = 'La versión 7 y superiores de PHP no están soportadas.';
$string['unsupportedphpversion71'] = 'La versión 7.1 y superiores de PHP no están soportadas.';
$string['unsupportedphpversion72'] = 'La versión 7.2 y superiores de PHP no están soportadas.';
$string['unsupportedphpversion73'] = 'La versión 7.3 y superiores de PHP no están soportadas.';
$string['unsupportedphpversion74'] = 'La versión 7.4 y superiores de PHP no están soportadas.';
$string['unsupportedphpversion80'] = 'La versión 8.0 y superiores de PHP no están soportadas.';
$string['unsupportedphpversion81'] = 'La versión 8.1 y superiores de PHP no están soportadas.';
$string['unsupportedphpversion82'] = 'PHP versión 8.2 y superiores no están soportados.';
$string['unsupportedphpversion83'] = 'PHP versión 8.3 y superiores NO están soportadas.';
...
$string['userfeedbackencouragement'] = 'Moodle incluye una característica que le da a los usuarios la opción de proporcionar retroalimentación acerca del programa Moodle mediante un sitio externo para encuestas alojado por Moodle HQ. No se envía ninguna información que pudiera identificar al usuario al sitio de encuestas</p>
...
$string['userfiltersdefault_desc'] = 'Seleccionar los filtros que quiere mostrar en la página de \'\'Acciones masivas con usuarios\'. Mantenga oprimida la tecla  Ctrl para seleccionar varios filtros. Los filtros no seleccionados estarán disponibles mediante el enlace para \'Mostrar más\'.';
...
$string['xmlrpcwebserviceenabled'] = 'Se ha detectado que el protocolo de Servicio Web XML-RPC  está habilitado en su sitio. Esta característica depende de la extensión PHP XML-RPC, la cual ya no es mantenida por PHP.';
